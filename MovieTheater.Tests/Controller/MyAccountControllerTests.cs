...
public class MyAccountControllerTests
{
    ...
    {
        var user = new ProfileUpdateViewModel {
            AccountId = "user1", Username = "testuser", Password = "pass", FullName = "Test User",
            DateOfBirth = DateOnly.FromDateTime(DateTime.Now.AddYears(-20)), Gender = "male", IdentityCard = "123456789",
            Email = "test@example.com", Address = "Test Address", PhoneNumber = "0123456789", Image = "img.png", ImageFile = null
        };
        var controller = CreateControllerWithUser(user);
        var model = new ProfilePageViewModel { Profile = new ProfileUpdateViewModel {
            AccountId = "user1", Username = "testuser", Password = "pass", FullName = "Test User",
            DateOfBirth = DateOnly.FromDateTime(DateTime.Now.AddYears(-20)), Gender = "male", IdentityCard = "123456789",
            Email = "test@example.com", Address = "Test Address", PhoneNumber = "0123456789", Image = "img.png", ImageFile = null
        } };
    ...
    public async void UpdateImage_UpdateFailed_ReturnsRedirectToMainPageWithError()
    {
        var user = new ProfileUpdateViewModel {
            AccountId = "user1", Username = "testuser", Password = "pass", FullName = "Test User",
            DateOfBirth = DateOnly.FromDateTime(DateTime.Now.AddYears(-20)), Gender = "male", IdentityCard = "123456789",
            Email = "test@example.com", Address = "Test Address", PhoneNumber = "0123456789", Image = "img.png"
        };
        var controller = CreateControllerWithUser(user);
        var model = new ProfilePageViewModel { Profile = user };
        _accountServiceMock.Setup(s => s.Update(user.AccountId, It.IsAny<RegisterViewModel>())).Returns(false);
