...
namespace MovieTheater.Tests.Hubs
{
    public class CinemaHubTests
    {
        ...
        public async Task JoinCinemaRoom_AddsConnectionToGroup()
        {
            ...
            // Assert
            _mockGroups.Verify(g => g.AddToGroupAsync(connectionId, $"cinema_room_{cinemaRoomId}", It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task JoinCinemaRoom_WithDifferentRoomIds_AddsToCorrectGroups()
        {
            ...
            // Assert
            _mockGroups.Verify(g => g.AddToGroupAsync(connectionId, "cinema_room_1", It.IsAny<CancellationToken>()), Times.Once);
            _mockGroups.Verify(g => g.AddToGroupAsync(connectionId, "cinema_room_2", It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task LeaveCinemaRoom_RemovesConnectionFromGroup()
        {
            ...
            // Assert
            _mockGroups.Verify(g => g.RemoveFromGroupAsync(connectionId, $"cinema_room_{cinemaRoomId}", It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task LeaveCinemaRoom_WithDifferentRoomIds_RemovesFromCorrectGroups()
        {
            ...
            // Assert
            _mockGroups.Verify(g => g.RemoveFromGroupAsync(connectionId, "cinema_room_1", It.IsAny<CancellationToken>()), Times.Once);
            _mockGroups.Verify(g => g.RemoveFromGroupAsync(connectionId, "cinema_room_2", It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task JoinCinemaRoom_WithZeroRoomId_AddsToGroupWithZero()
        {
            ...
            // Assert
            _mockGroups.Verify(g => g.AddToGroupAsync(connectionId, "cinema_room_0", It.IsAny<CancellationToken>()), Times.Once);
        }
        ...
        public async Task LeaveCinemaRoom_WithNegativeRoomId_RemovesFromGroupWithNegative()
        {
            ...
            // Assert
            _mockGroups.Verify(g => g.RemoveFromGroupAsync(connectionId, "cinema_room_-1", It.IsAny<CancellationToken>()), Times.Once);
        }
